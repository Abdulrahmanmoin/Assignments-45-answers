...
console.log(chalk.magenta("Answer 43"));

let magiciansArray: string[] = ["zahid" , "junaid" , "qais" , "ramiz"] 
...
function makeGreat(magicians: string[] = copyMagiciansArray){
    let copyMagicians: string[] = [];
...
console.log(chalk.magenta("Answer 44"));
...
console.log(chalk.magenta("Answer 45"));


function carFunc(manufacturer: string , model: string, ...args: any[]){
