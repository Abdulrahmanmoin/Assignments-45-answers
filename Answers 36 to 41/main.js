...
console.log(chalk_1.default.magenta("Answer 36"));
...
console.log(chalk_1.default.magenta("Answer 37"));
function makeNewShirt(size = "Large", message = "I love Typescript") {
...
console.log(chalk_1.default.magenta("Answer 38"));
function describeCity(city = "Karachi", country = "Pakistan") {
...
// "Lahore, Pakistan"
console.log(chalk_1.default.magenta("Answer 39"));
...
console.log(chalk_1.default.magenta("Answer 40"));
...
console.log(chalk_1.default.magenta("Answer 41"));
