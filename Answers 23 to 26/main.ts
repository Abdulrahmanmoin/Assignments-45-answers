...
console.log("Inequality test with strings: 'Karachi' != 'Lahore'", ("karachi" as string) != "Lahore" )

// For False

console.log("Equality test with strings: 'Karachi' == 'Lahore'", ("karachi" as string) == "Lahore" )
...
console.log("Inequality test with strings: 12 != 11", (12 as number) != 11 )

// For false
console.log("Equality test with numbers: 12 == 11", (12 as number) ==  11)
...
console.log("Less than test: 11 < 12", (11 as number) < 12) 

// For false
console.log("Greater than test: 12 > 13", 12 > 13)
console.log("Less than test: 12 < 11", (12 as number) < 11)
...
// for false
console.log("Test using and operator: 13 == 13 & 13 < 12", 13 == 13 && 13 < 12)
console.log("Test using OR operator: 13 > 13 || 13 == 12", 13 > 13 || (13 as number) == 12)
...
let garriyan: string[] = ["Mehran" , "Prado" , "Vigo"]
let garri: string = "Civic";
